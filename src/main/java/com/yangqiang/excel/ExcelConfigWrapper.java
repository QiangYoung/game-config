...
public class ExcelConfigWrapper implements IConfigWrapper {
    ...
    public ExcelConfigWrapper build() {
        ...
        if (workbook == null) {
            throw new RuntimeException(String.format("【%s】打开excel文件失败", excelFilePath));
        }
